...
| Session files | What a session file persists (view state), what it excludes (data / derived state), and schema-evolution policy | [io/session-files.md](io/session-files.md) |
