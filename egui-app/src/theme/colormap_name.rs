...
/// UI/theme-side entry point that converts `ColormapName` into a `ColorMap`.
/// Centralized here to decouple the state layer's types from theme implementation details.
